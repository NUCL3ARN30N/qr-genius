...
> Advanced QR code generator with custom styles, embedded icons & live preview
...
| 4 | Colors | Foreground, Background, Corner Square, Corner Dot |
| 5 | Center Icons | 15 presets + custom image upload |
| 6 | Error Correction | L (7%), M (15%), Q (25%), H (30%) |
| 7 | Size & Margin | 150–1000px, margin 0–50 |
...
**Dependencies:** Loaded via CDN (QR Code Styling, Font Awesome, Google Fonts)
